      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <button type="button" class="btn btn-primary btn-lg  d-flex justify-content-end align-items-end">buy new</button>
          </div>
			...
			<div class="container">
				<div class="row text-center fh5co-heading row-padded">
					<div class="col-md-8 col-md-offset-2">
						<h2 class="heading to-animate">Reserve a place</h2>
